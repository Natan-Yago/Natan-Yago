      ...
      <div className="grid-cell">
        <div className="flex justify-between items-center mb-10">
          ...
          <ActionButton 
            ...
            icon={<BriefcaseIcon className="h-3 w-3" aria-hidden="true" />}
          />
        </div>
          <div className="grid grid-cols-1 gap-4 lg:gap-5">
            <SpotlightBorder borderColor="rgb(151, 151, 151)" spotlightSize="30% 40px">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground sm:text-base text-xs">Website Developer</p>
                    </div>
                  </div>
                  <p className="text-muted-foreground sm:text-base text-xs">2023 - Present</p>
                </div>
              </div>
            </SpotlightBorder>
                ...
                <div className="flex justify-between items-start">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground sm:text-base text-xs">Webmaster</p>
                    </div>
                  </div>
                  <p className="text-muted-foreground sm:text-base text-xs">2022 - 2023</p>
                </div>
              </div>
            </SpotlightBorder>
          </div>
